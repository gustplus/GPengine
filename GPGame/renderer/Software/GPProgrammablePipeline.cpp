#include "GPProgrammablePipeline.h"
#include "gp.h"
#include "gpmath.h"
...
namespace GPEngine3D{
	...
	ProgrammablePipeline::ProgrammablePipeline(PixelFormat pixel_format, char depthBits, char stencilBits, bool doubleBuffer, int width, int height):
	...
	ProgrammablePipeline::~ProgrammablePipeline()
	{
		GP_SAFE_DELETE_ARRAY(_bColorBuffer);
		GP_SAFE_DELETE_ARRAY(_fDepthBuffer);
	}

	bool ProgrammablePipeline::initContent()
	{
		if(_bColorBuffer)
		{
			return true;
	...
	void ProgrammablePipeline::drawPoint(const Point2i &v, const Color3b &color)
	{
	...
	void ProgrammablePipeline::drawPoint(int x, int y, const Color3b &color)
	{
	...
	void ProgrammablePipeline::drawLine(int x0, int y0, int x1, int y1, const Color3b &color)
	{
		int dx = x1 - x0;
		int dy = y1 - y0;
		if(dx == 0 && dy == 0)
	...
	void ProgrammablePipeline::drawTriangleSolidFlat(const PolyTriangle &triangle)
	{
	...
	void ProgrammablePipeline::drawTriangleSolidFlat(const Vertex &v0, const Vertex & v1, const Vertex &v2)
	{
	...
	void ProgrammablePipeline::drawTriangleSolidColor(const PolyTriangle &triangle)
	{
		const Vertex &v0 = triangle.tranList[0];
		const Vertex &v1 = triangle.tranList[1];
		const Vertex &v2 = triangle.tranList[2];
	...
	void ProgrammablePipeline::drawTriangleSolidColor(const Vertex &v0, const Vertex & v1, const Vertex &v2)
	{
		int idx0 = 0;
		int idx1 = 1;
		int idx2 = 2;
	...
	void ProgrammablePipeline::drawTriangleSolidTexNearest(const PolyTriangle &triangle, const Texture2D &tex)
	{
		const Vertex &v0 = triangle.tranList[0];
		const Vertex &v1 = triangle.tranList[1];
		const Vertex &v2 = triangle.tranList[2];
	...
	void ProgrammablePipeline::drawTriangleSolidTexNearest(const Vertex &v0, const Vertex & v1, const Vertex &v2, const Texture2D &tex)
	{
		int idx0 = 0;
		int idx1 = 1;
		int idx2 = 2;
	...
	void ProgrammablePipeline::drawTriangleSolidTexLinear(const PolyTriangle &triangle, const Texture2D &tex)
	{
		const Vertex &v0 = triangle.tranList[0];
		const Vertex &v1 = triangle.tranList[1];
		const Vertex &v2 = triangle.tranList[2];
	...
	void ProgrammablePipeline::drawTriangleSolidTexLinear(const Vertex &v0, const Vertex & v1, const Vertex &v2, const Texture2D &tex)
	{
		int idx0 = 0;
		int idx1 = 1;
		int idx2 = 2;
	...
	void ProgrammablePipeline::drawTriangleSolidColorTex(const PolyTriangle &triangle, const Texture2D &tex)
	{
		const Vertex &v0 = triangle.tranList[0];
		const Vertex &v1 = triangle.tranList[1];
		const Vertex &v2 = triangle.tranList[2];
	...
	void ProgrammablePipeline::drawTriangleSolidColorTex(const Vertex &v0, const Vertex & v1, const Vertex &v2, const Texture2D &tex)
	{
		int idx0 = 0;
		int idx1 = 1;
		int idx2 = 2;
	...
	void ProgrammablePipeline::setClearColor(const ColorRGBA &color)
	{
	...
	void ProgrammablePipeline::clearBuffer(ATTR_FLAG flags)
	{
		_clearColorBuffer();
	...
	void ProgrammablePipeline::clearBuffer()
	{
		_clearColorBuffer();
		_clearDepthBuffer();
	...
	void ProgrammablePipeline::_clearColorBuffer()
	{
	...
	void ProgrammablePipeline::_clearDepthBuffer()
	{
	...
	void ProgrammablePipeline::swapBuffer()
	{
		glWindowPos2d(0, 0);
		glDrawPixels(iWidth,iHeight, GL_RGB, GL_UNSIGNED_BYTE, _bColorBuffer);
	}

	void ProgrammablePipeline::resizeViewPort(int width, int height)
	{
		iWidth = width;
		iHeight = height;
	...
	void ProgrammablePipeline::drawArray(PolyObject &buffer, uint_32 offset, uint_32 faceCount)
	{
	...
	void ProgrammablePipeline::drawElements(RenderList &buffer, GLushort *const indices, uint_32 count)
	{
		if(buffer.isEnabled(POLY_ATTR::ENABLE_TEX))
		{
			Texture2D *tex = buffer.getTexture();
	...
	void ProgrammablePipeline::_removeBackFaces(PolyObject &buffer, uint_32 offset, uint_32 count)
	{
	...
	*/
	void ProgrammablePipeline::projectionToScreenTransform(PolyObject &buffer, uint_32 offset, uint_32 count)
	{
		for (int index = offset; index < offset + count; ++index)
		{
	...
	void ProgrammablePipeline::projectionToScreenTransform(RenderList &buffer)
	{
	...
	void ProgrammablePipeline::enable(ATTR_FLAG flag)
	{
	...
	void ProgrammablePipeline::disable(ATTR_FLAG flag)
	{
		_attr &= ~flag;
	}
}